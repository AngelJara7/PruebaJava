...
public class ModuloEntradaDatos implements ActionListener {
	...
	public JButton b_guardar, b_cancelar;
    ...
    public ModuloEntradaDatos(ModuloCliente moduloCliente, boolean modal) {
    ...
    public void InicilizarComponentes(){
    	...
    	entradaDatos.add(panelPrincipal);
        ...
        l_cedula.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        ...
        l_email.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
